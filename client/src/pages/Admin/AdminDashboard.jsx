...
const AdminDashboard = () => {
  ...
  return (
    <div className="admin-dashboard-container">
      ...
      {/* Row 2: Recent Order Chart Widget */}
      ...
      {/* Row 3: Top Products list & Sales by Category list */}
      <section className="details-grid grid">
        ...
        {/* Top Categories By Sales (Duplicates Countries Sales aesthetic in Remos) */}
        <div className="card detail-section-card">
          <div className="detail-section-header">
      ...
      {stats?.lowStockProducts?.length > 0 && (
        <section className="card detail-section-card" style={{ borderLeft: "4px solid var(--color-error)", minHeight: "auto", padding: 20 }}>
