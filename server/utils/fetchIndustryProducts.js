  ...
  try {
    ...
    for (const source of CATEGORY_SOURCES) {
      for (let page = 1; page <= 3; page++) {
        ...
        console.log(`🌐 Crawling URL: ${pageUrl} &rarr; ${source.category} (Page ${page})`);
        ...
        try {
          ...
          console.error(`   ⚠️ Failed to load page ${pageUrl}: ${err.message}`);
          continue;
        }
        ...
        console.log(`   * Page ${page}: Found ${items.length} product elements. Extracting data...`);
